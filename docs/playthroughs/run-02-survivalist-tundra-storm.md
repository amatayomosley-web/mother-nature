# Run 02 — Survivalist, Tundra, Plane Crash, Storm

Date of run: 2026-05-09
Status: Day 4 in-game, alive, survival arc continuing
Run author: William + Claude (design exercise)

## Setup

- **Character**: "Ari" (placeholder name) — Survivalist node
- **Biome**: Tundra, late autumn turning to winter
- **Weather at start**: Cat-3 storm in progress, -15°C, wind 65 km/h NNW, wet snow falling, visibility ~15m
- **Daylight**: ~6 hours of twilight before full dark
- **Scenario**: Bush plane crash. Pilot dead. Plane partially intact ~30m from impact point.

### Starting kit (Survivalist + crash-scenario loot)

- Survivalist standard: spear, knife, atlatl + 4 darts, fire-kit (flint-and-steel + waterproof tinder), wool layered clothing, leather/wool boots
- Plane survival kit: mylar emergency blanket, ~5 days dehydrated emergency food, flare gun + 3 flares, basic medical kit (bandages, antiseptic, painkillers), signal mirror, broken radio (no rescue capability)
- Plane wreckage materials: aluminum panels, fuel-soaked rags, frayed tarp from cargo netting, copper wiring
- Pilot: dead from impact trauma. Has a hunting rifle (.30-06) on a sling, half-box of ammo (~10 rounds). Ari can take the rifle.

### Compendium grants at start

- Expert: fire-craft, shelter-construction, cold-management, water-purification, basic navigation
- Practiced: cold-weather wildlife (caribou, ptarmigan, hare), plant-ID winter-tundra (no plant grows in current conditions)
- Novice: bow handling (Survivalist cross-domain), tracking
- Glimpsed: predator-reading

### Skill node

Survivalist — fire-craft, shelter-building, cold-management, water-purification, navigation

### Goal

Survive. River ~12km southeast based on terrain reading. Aircraft search range ~3 days; after that, no rescue.

---

## Beat 1 — T+0 to T+45min, immediate triage

Ari conscious in pilot seat, thrown forward against safety harness. Disoriented. Storm howls outside. Plane fuselage tipped to port, partially in snowdrift. Through cracked windshield: blowing snow, no horizon, dim daylight failing.

**Body assessment** (Survivalist self-reading, post-Expert):
- Bruised ribs, chest hurts on inhale (1-2 cracked, not displaced)
- Mild concussion symptoms (dizziness, nausea)
- No lacerations
- Cold creeping in through cabin breach

**Pilot check** — beside her, head against side window. No pulse. Already cooling.

**Three immediate priorities, 5-minute window before cold becomes critical:**
1. Get out of broken aircraft (hypothermia in stationary breached cabin = death)
2. Find or build immediate shelter from wind
3. Inventory what survived

She crawls back through fuselage. Cargo bay: emergency supplies still strapped. Takes survival kit + her personal gear + (after a beat of weighing) the pilot's rifle and ammo. Pilot's body she leaves; cannot bury in storm; deals with later.

**§14.13 saliency tests immediately**: Survivalist's Expert tier in shelter-construction means her eye catches three viable shelter sites within visible range — a snow drift on the lee side of the wreckage suitable for snow-pit; a rock outcrop ~100m off offering wind break; the wreckage's downwind side itself. The novice would see "snow everywhere"; she sees three options ranked by viability.

**Decision**: wreckage-as-windbreak + dig-snow-pit. Closest, fastest. Risk: if plane fuel ignites or is found by predators, the wreckage is bad. Benefit: 3-minute shelter setup vs 30-minute build elsewhere.

**Needs surfaced:**
- N23 — In-aircraft injury system (cracked rib, concussion)
- N24 — Body recovery / disposal of dead human bodies (pilot's body becomes future scent beacon)

## Beat 2 — T+45min to T+4hrs, building immediate shelter

She digs a snow pit on the lee side of the wreckage. Working in storm + cold she's burning calories fast. Visible breath cloud at every exhale. Cracked rib makes deep digging painful.

**Snow-pit construction** (Survivalist Expert, post-mastery):
- Scrapes pit ~1.5m × 2m × 1m deep into the drift
- Lines bottom with aluminum panel from wreckage (insulation barrier)
- Tarp from cargo over top, weighted with snow blocks
- Small entrance shaft on downwind side

~90 minutes of work in storm. **Quality grade B** — would be A in calm conditions; storm interrupted detailed work. Provides wind-break, retains body heat, blocks blowing snow.

**Fire** (Expert fire-craft, hardest possible conditions):
- Inside snow-pit, small contained fire
- Fuel-soaked rags from plane as accelerant (~1 hour of guaranteed flame)
- Then natural fuel — dwarf willow stems, aircraft fragments, pilot's plastic clipboard (sparingly — toxic fumes)
- **§13.4 Wet Wood at maximum stress** — tundra wood is dry once snow brushed off, but availability is the constraint

Fire alive by T+3hrs. Heat recovers. Melts snow in cookpan from survival kit, drinks warm water — first calories absorbed in hours.

**Body state** at T+4hrs:
- Warmth: 70% (recovered)
- Hunger: 60% (one ration eaten)
- Thirst: 60% (warm water)
- Cracked rib: persistent pain, breathing shallow
- Concussion: dizziness fading; will need real sleep to fully clear
- Tiredness: 50%

**Needs surfaced:**
- N25 — Snow-pit shelter recipe
- N26 — Fuel scarcity in tundra (limited materials, burn profiles)
- N27 — Aluminum-panel-as-insulation-barrier; improvised-from-wreckage crafting
- N28 — Cracked rib + breathing depth (extends G22 injury)

## Beat 3 — T+4hrs to T+18hrs (night-1)

Storm continues through the night. Visibility zero. Wind battering the snow-pit cover. She tends fire intermittently — wakes every ~90 minutes to add fuel, check tarp anchors, melt water.

**Sleep is impossible at this depth of cold + injury + fuel-stress.** She doses, never deep.

**Mid-night, ~T+10hrs**, she hears a wolf howl in the distance. ~2km off. She's downwind of where the wreckage scent + (eventually) pilot's body scent will travel. Predator pressure becomes real.

**Mid-night decision:**
- Pilot's body is ~30m off in broken cockpit. Cold has preserved it; scent moderate but rising.
- If wolves catch the scent, they'll come investigate. They'll find pilot's body first (closer to wind, easier access). Carrion Chains activates on a HUMAN body.
- Options: leave pilot for wolves (lets them eat there, away from her); drag pilot further (50m+); somehow render scentless (not feasible).

She makes the decision: leaves pilot in place. **Diegetic acceptance** — survival ethic. The dead can feed the wolves and keep them off her.

**Needs surfaced:**
- N29 — Human carrion as Carrion-Chains entity
- N30 — Sleep deprivation cumulative effect

## Beat 4 — Dawn day-2, T+24hrs

Storm passes ~T+22hrs. By T+24 the sky is clearing; sun rising weakly above horizon at ~45° south. Still cold (-12°C), wind dropping to ~20 km/h. Visibility ~3km.

She emerges from snow-pit. Scene:
- Plane wreckage 30m off, partially buried under fresh snow
- Pilot's body partially scavenged — wolves came in night, took limbs and torso. Tracks lead off west. ~3 wolves, mid-sized, fed.
- Ari is alive. Her shelter held.

**Body state**: tiredness 30%, warmth 65%, hunger 50% (1.5 days food gone), pain 50% (rib), concussion 80% recovered. Breathing shallow but functional.

**§14.13 saliency continues firing**: Survivalist's eye catches in the morning light:
- Caribou tracks ~200m off — herd of ~6, traveling SE through the night, sometime during the storm
- A patch of dwarf willow on a slight rise — fuel source, ~50m off
- A frozen tarn ~400m east — water source if she can chip through ice
- The river direction confirmed by mountain alignment SE

**Decisions for Day 2:**
1. Stay at wreckage (windbreak shelter intact, dwindling resources, predator pressure rising)
2. Hike toward river (12km, severe terrain, exposes her)
3. Hike toward caribou herd (6km, food source, but they're moving)

She chooses staying + scout-trips. Day 2 work: chips ice from tarn (water), gathers dwarf willow (fuel), maintains fire, patches snow-pit shelter to grade A, sets one snare on a hare run.

**Body state end of day 2:**
- Warmth 75%, hunger 50% (1 ration), thirst 80%, tiredness 50%, pain 35% (rib stable), concussion clear
- Sleep night 2: grade-B in improved shelter

## Beat 5 — Day 3-4 (compressed), the wolves return

**Day 3** — routine maintenance. Snare empty. Fuel stockpile growing. Hare populations thin in winter. Atlatl miss on a ptarmigan (post-mastery for her but ptarmigan small + fast).

**Day 4 dawn** — wolves return. Three of them at the wreckage, picking at pilot's bones. They have eaten well; behavior is post-feeding — relaxed, not aggressive. They notice Ari at her shelter ~30m off but don't approach.

**§14.13 saliency**: Ari is *Glimpsed* in predator-reading (Survivalist isn't a Hunter). Saliency overlay for the wolves is minimal — she sees three canids, knows they're wolves, can't read pack-state cues like a Tracker would.

**She has the rifle.** §15 rifle has 100-300m range, kills wolves in 1 shot reliably. But:
- Sound carries 2-3km in cold air — broadcasts her position drainage-wide
- Ammo is finite (10 rounds total)
- A dead wolf attracts more wolves to scavenge (Carrion Chains again)
- Wolves aren't currently aggressive; firing escalates

**She does not shoot.** Stays in shelter. Wolves finish at the body, leave west. **Compendium logs**: "*wolves returned to pilot's body day 4 dawn, post-feeding behavior, no aggression toward me at 30m.*"

**This is the decision the rifle's cost-matrix produces in §15. Range + power available; sound + ammo + escalation costs prevent reflexive use. No Dominant Strategy in action.**

**Need surfaced:**
- N31 — Predator reading skill differential by node (Survivalist sees less than Hunter would)

---

## Run 02 partial state at end of day 4

- Alive. Sheltered. Predator-pressure managed without engagement.
- Food: 0.5 ration left (was 5; consumed over 4 days)
- Fuel: ~3 days stockpiled
- Water: tarn ice + fire + cookpan = sustainable
- Body: rib still healing, ~70% recovered overall
- Decision still owed: hike to river (12km, dangerous) or stay and burn through last ration trying to hunt locally

The tundra is becoming a slow-cinch. Day 5+ pushes toward food-pressure crisis or migration. Death possible mechanically, but Survivalist is well-equipped — likely outcome is survival arc continuing.

---

## Architecture stress-test results (Run 02 days 1-4)

- ✅ **§14 debuff-removal model**: Survivalist's domain (cold, fire, shelter) firing in-character. Non-Survivalist debuffs (limited predator-reading, limited hunting) made the wolf encounter and ptarmigan miss feel honest.
- ✅ **§14.13 saliency**: Extensively tested. Survivalist's eye caught dwarf willow, ice-tarn, drainage SE, snow-pit-viable drifts, quality fuel sources. Same world; different visual weights for her vs (hypothetical) Hunter character.
- ✅ **§15 combat**: Rifle present but unused. Cost matrix did its job — sound broadcast + ammo scarcity + escalation = real disincentive against reflex use. No Dominant Strategy held.
- ✅ **§13.2 Carrion Chains**: Pilot's body activated chain. Wolves followed scent. Ari's shelter siting decision (downwind, away from corpse) was load-bearing for survival.
- ✅ **§2 Mechanical-behavior principle**: Every event emerged from inputs aligning. No "narrative pacing" needed. Storm is harsh because it's a storm; wolves came because of scent; Ari's choices were dictated by mechanical state, not designer arrangement.

## New gaps from Run 02 (N23-N31)

| # | Gap/Need | Severity |
|---|---|---|
| N23 | In-aircraft / in-vehicle injury (cracked rib, concussion) | HIGH |
| N24 | Human-body disposal / handling | MEDIUM |
| N25 | Snow-pit shelter recipe | HIGH |
| N26 | Fuel typology in tundra | HIGH |
| N27 | Improvised-from-wreckage crafting | MEDIUM |
| N28 | Cracked rib effect on stamina/breathing/sleep | HIGH |
| N29 | Human corpse as Carrion-Chains entity | MEDIUM |
| N30 | Sleep deprivation cumulative across nights | HIGH |
| N31 | Per-node predator-reading skill differential | LOW |

## What Run 02 confirmed differently from Run 01
